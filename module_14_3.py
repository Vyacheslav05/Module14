...
async def get_buying_list(message):
    products = [
        {'name': 'Product1', 'description': 'Описание 1', 'price': 100, 'image': 'file/picture1.png'},
        {'name': 'Product2', 'description': 'Описание 2', 'price': 200, 'image': 'file/picture2.png'},
        {'name': 'Product3', 'description': 'Описание 3', 'price': 300, 'image': 'file/picture3.png'},
        {'name': 'Product4', 'description': 'Описание 4', 'price': 400, 'image': 'file/picture4.png'}
    ]
